    ...
    render() {
        return (
            <Navbar collapseOnSelect expand="lg" id="navbar" variant="dark">
                ...
                {this.props.loggedIn ? (
                    <AddOperationModal show={this.state.showLoginAlert} onHide={this.toggleLoginAlert} action={this.toggleLoginForm} user={this.props.loggedIn} updateOperations={this.props.updateOperations} />
                ) : (
